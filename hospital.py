...
#=======================lable for Blood Preessure++++++++++++++++
        ...
        txtBloodPress=Entry(Dataframeleft,font=("arial",12,"bold"),width=35)
...
##############################Scrolbar++++++++++++++++++++
        ...
        self.hospital_table.Treeview(Detailsframe,column=("nameoftable","ref","dose","nooftablets","lot","issuedate","expdate",
                                                        "dailydose","storage","nhsnumber","dob","pname","address"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.hospital_table.column("nemaeoftable",width=100)
